...
$spec = Pearfarm_PackageSpec::create(array(Pearfarm_PackageSpec::OPT_BASEDIR => dirname(__FILE__)))
          ...
          ->setReleaseVersion('0.0.13')
          ->setApiVersion('0.0.13')
          ->setApiStability('alpha')
          ->setLicense(Pearfarm_PackageSpec::LICENSE_MIT)
          ->setNotes('Make storyId optional for git-planbox start so you can switch tasks without having to enter a storyId')
